...
VALUES
        (
                ...
                'Shibuya, Tokyo, Japan',
                'Expert',
                '/images/doctorFEMALE.jpeg'
        ),
        (
                'USR-EXP-002',
                'Andrew Nguyen',
                'andrew.nguyen@latee.com',
                '(568) 367-987-237',
                '1982-11-20',
                'expert2',
                'Male',
...
-- ==========================================
-- BỔ SUNG THÊM USERS (2 EXPERTS, 3 LEARNERS)
-- ==========================================
INSERT INTO
        users (
                userid,
...
VALUES
        ...
        (
                'USR-EXP-005',
                'Tu Nguyen',
                'tu.nguyenhydekiri@hcmut.edu.vn',
                '(568) 444-555-666',
                '1979-03-12',
                '123456789',
                'Female',
...
INSERT INTO
        learner (lid, ssn)
VALUES
        ('USR-LRN-006', '052204022954'),
        ('USR-LRN-007', '052204022955'),
        ('USR-LRN-008', '052204022956');
...
VALUES
        (
                'USR-EXP-005',
                '052204022957',
                'Dedicated to advancing pediatric care through simulation and hands-on clinical mentorship.',
                'MD Pediatrics - Oxford University',
                'Pediatric Clinical Educator',
                'Pediatrics, Clinical Mentorship, Simulation Training',
                'https://linkedin.com/in/sarahjenkins'
        ),
        (
                'USR-EXP-006',
                '052204022958',
                'Specializes in emergency medicine and acute care training. Passionate about rapid-response medical education.',
                'MD Emergency Medicine - University of Toronto',
                'Emergency Medicine Specialist',
                'Emergency Medicine, Acute Care, Rapid Response',
...
INSERT INTO
        evaluation_clinical_criteria (id, description, version)
VALUES
        (
                'CRIT-001',
        ...
        (
                'CRIT-003',
                'Clinical Simulation Performance',
                'V2.1'
        );

-- Expert Criteria Management
INSERT INTO
        expert_criteria_management (expert_id, criteria_id)
VALUES
...
-- Guideline
INSERT INTO
        guideline (id, description, version, created_at, updated_at)
VALUES
        (
                'GL01',
...
INSERT INTO
        expert_guideline_management (expert_id, guideline_id)
VALUES
        ('USR-EXP-001', 'GL01');
...
INSERT INTO
        revoked_access_tokens (jti, user_id, expires_at, reason)
VALUES
        (
                'JWT-OLD-999',
                'USR-LRN-01',
...
VALUES
        (
                ...
                15,
                'Intermediate',
                '{"rules": ["Chief Concern", "HPI", "Diagnostic Impression"], "totalTime": "45"}',
                'published',
                'https://example.com/avatars/richard_anderson.png'
        );
...
VALUES
        (
                ...
                '{"rules": ["Chief Concern", "HPI", "Diagnostic Impression"], "totalTime": "45"}',
                'published',
                'https://example.com/avatars/anthony_garcia.png'
        );
...
VALUES
        (
                ...
                '{"rules": ["Chief Concern", "HPI", "Diagnostic Impression"], "totalTime": "45"}',
                'published',
                'https://example.com/avatars/richard_jackson.png'
        );
...
VALUES
        (
                ...
                '{"rules": ["Chief Concern", "HPI", "Diagnostic Impression"], "totalTime": "45"}',
                'published',
                'https://example.com/avatars/donald_rodriguez.png'
        );
...
VALUES
        (
                ...
                '{"rules": ["Chief Concern", "HPI", "Diagnostic Impression"], "totalTime": "45"}',
                'published',
                'https://example.com/avatars/richard_lopez.png'
        );
...
VALUES
        (
                ...
                '{"rules": ["Chief Concern", "HPI", "Diagnostic Impression"], "totalTime": "45"}',
                'published',
                'https://example.com/avatars/donna_davis.png'
        );
...
VALUES
        (
                ...
                '{"rules": ["Chief Concern", "HPI", "Diagnostic Impression"], "totalTime": "45"}',
                'active',
                'https://example.com/avatars/william_martinez.png'
        );
...
VALUES
        (
                ...
                '{"rules": ["Chief Concern", "HPI", "Diagnostic Impression"], "totalTime": "45"}',
                'published',
                'https://example.com/avatars/michael_smith.png'
        );
...
VALUES
        (
                ...
                '{"rules": ["Chief Concern", "HPI", "Diagnostic Impression"], "totalTime": "45"}',
                'active',
                'https://example.com/avatars/sandra_jackson.png'
        );
...
VALUES
        (
                ...
                '{"rules": ["Chief Concern", "HPI", "Diagnostic Impression"], "totalTime": "45"}',
                'active',
                'https://example.com/avatars/matthew_jones.png'
        );
...
VALUES
        (
                ...
                '{"rules": ["Chief Concern", "HPI", "Diagnostic Impression"], "totalTime": "45"}',
                'active',
                'https://example.com/avatars/jessica_gonzalez.png'
        );
...
VALUES
        (
                ...
                '{"rules": ["Chief Concern", "HPI", "Diagnostic Impression"], "totalTime": "45"}',
                'published',
                'https://example.com/avatars/emily_rodriguez.png'
        );
...
VALUES
        (
                ...
                '{"rules": ["Chief Concern", "HPI", "Diagnostic Impression"], "totalTime": "45"}',
                'active',
                'https://example.com/avatars/william_miller.png'
        );
...
VALUES
        (
                ...
                '{"rules": ["Chief Concern", "HPI", "Diagnostic Impression"], "totalTime": "45"}',
                'active',
                'https://example.com/avatars/daniel_thomas.png'
        );
...
VALUES
        (
                ...
                '{"rules": ["Chief Concern", "HPI", "Diagnostic Impression"], "totalTime": "45"}',
                'archived',
                'https://example.com/avatars/michael_hernandez.png'
        );
...
VALUES
        (
                ...
                '{"rules": ["Chief Concern", "HPI", "Diagnostic Impression"], "totalTime": "45"}',
                'draft',
                'https://example.com/avatars/thomas_lopez.png'
        );
...
VALUES
        (
                ...
                '{"rules": ["Chief Concern", "HPI", "Diagnostic Impression"], "totalTime": "45"}',
                'active',
                'https://example.com/avatars/susan_thomas.png'
        );
...
VALUES
        (
                ...
                '{"rules": ["Chief Concern", "HPI", "Diagnostic Impression"], "totalTime": "45"}',
                'published',
                'https://example.com/avatars/william_brown.png'
        );
...
VALUES
        (
                ...
                '{"rules": ["Chief Concern", "HPI", "Diagnostic Impression"], "totalTime": "45"}',
                'active',
                'https://example.com/avatars/michael_miller.png'
        );
...
VALUES
        (
                ...
                '{"rules": ["Chief Concern", "HPI", "Diagnostic Impression"], "totalTime": "45"}',
                'published',
                'https://example.com/avatars/mary_taylor.png'
        );

INSERT INTO
        labtestitem (itemid, label, fluid, category, count)
VALUES
...
INSERT INTO
        labtestitem (itemid, label, fluid, category, count)
VALUES
        (50956, 'Lipase', 'Blood', 'Chemistry', 1000);

INSERT INTO
        labtestitem (itemid, label, fluid, category, count)
VALUES
        (50931, 'Glucose', 'Blood', 'Chemistry', 1000);
...
INSERT INTO
        expert_laboratory (expert_id, labtest_id)
SELECT
        'USR-EXP-001',
        id
FROM
...
INSERT INTO
        expert_radiology (expert_id, radiology_report_id)
SELECT
        'USR-EXP-001',
        id
FROM
...
INSERT INTO
        expert_clinical_case_management (expert_id, case_id)
VALUES
        ('USR-EXP-001', '27892518'),
...
INSERT INTO
        expert_virtual_patient_management (expert_id, virtual_id)
VALUES
        ('USR-EXP-001', '10070247'),
        ('USR-EXP-001', '10156068'),
        ('USR-EXP-001', '10185476'),
        ('USR-EXP-001', '10205542'),
        ('USR-EXP-001', '10071659'),
        ('USR-EXP-001', '10069551'),
        ('USR-EXP-001', '10058856'),
        ('USR-EXP-001', '10056223'),
        ('USR-EXP-002', '10073256'),
        ('USR-EXP-002', '10080679'),
        ('USR-EXP-002', '10085111'),
        ('USR-EXP-002', '10139369'),
        ('USR-EXP-002', '10154376'),
...
-- ==========================
INSERT INTO
        knowledge_resources (id, title, content, link, imageUrl, authorlist)
VALUES
        (
                'KR-001',
