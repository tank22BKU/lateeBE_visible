...
VALUES 
('USR-ADM-01', '052204022947');

-- Learner
INSERT INTO learner (lid, ssn)
VALUES 
('USR-LRN-01', '052204022949');
...
VALUES 
('CRIT-001', 'Patient Communication Excellence', 'V1.0'),
...
VALUES 
('TK-001', 'USR-EXP-001', 'hash_string_alpha_123', '2024-12-31 23:59:59', '1.1.1.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64)'),
('TK-002', 'USR-EXP-002', 'hash_string_beta_456', '2024-12-31 23:59:59', '8.8.8.8', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_7)');

INSERT INTO user_refresh_tokens (token_id, user_id, token_hash, expires_at, created_by_ip, user_agent)
VALUES 
('TKN-ADM-01', 'USR-ADM-01', 'abc123hash', '2026-06-01 10:00:00', '192.168.1.1', 'Chrome/Windows'),
...
VALUES 
('JWT-OLD-999', 'USR-LRN-01', '2026-05-01 08:00:00', 'User logged out');
...
'{"bp": "114/91", "hr": 79, "spo2": 97, "rr": 21, "temp": "36.7°C"}',
...
30, 15, 'Intermediate', '{"rules": ["Chief Concern", "HPI", "Diagnostic Impression"], "totalTime": "45 mins"}', 'active', 'https://example.com/avatars/richard_anderson.png');
...
'{"bp": "129/88", "hr": 85, "spo2": 96, "rr": 20, "temp": "38.9°C"}',
'{"role": "Medical Learner", "task": "Evaluate and diagnose", "procedure": ["Enter room", "Interaction", "Reasoning"]}',
'["Chronic alcohol consumption", "High pain tolerance", "Delayed hospital presentation"]',
'["Recognize appendicitis in elderly patients with high pain thresholds", "Analyze high fever (38.9°C) and right-sided guarding", "Evaluate appendicitis complications in patients with prior malignancy"]',
30, 15, 'Intermediate', '{"rules": ["Chief Concern", "HPI", "Diagnostic Impression"], "totalTime": "45 mins"}', 'active', 'https://example.com/avatars/anthony_garcia.png');
...
'{"bp": "120/92", "hr": 84, "spo2": 98, "rr": 22, "temp": "36.7°C"}',
'{"role": "Medical Learner", "task": "Evaluate and diagnose", "procedure": ["Enter room", "Interaction", "Reasoning"]}',
...
30, 15, 'Intermediate', '{"rules": ["Chief Concern", "HPI", "Diagnostic Impression"], "totalTime": "45 mins"}', 'active', 'https://example.com/avatars/richard_jackson.png');
...
'Chronic abdominal pain',
'{"bp": "133/94", "hr": 92, "spo2": 97, "rr": 21, "temp": "36.4°C"}',
'{"role": "Medical Learner", "task": "Evaluate and diagnose", "procedure": ["Enter room", "Interaction", "Reasoning"]}',
...
30, 15, 'Intermediate', '{"rules": ["Chief Concern", "HPI", "Diagnostic Impression"], "totalTime": "45 mins"}', 'active', 'https://example.com/avatars/donald_rodriguez.png');
...
'Chronic abdominal pain',
'{"bp": "134/75", "hr": 94, "spo2": 100, "rr": 17, "temp": "37.1°C"}',
'{"role": "Medical Learner", "task": "Evaluate and diagnose", "procedure": ["Enter room", "Interaction", "Reasoning"]}',
...
30, 15, 'Intermediate', '{"rules": ["Chief Concern", "HPI", "Diagnostic Impression"], "totalTime": "45 mins"}', 'active', 'https://example.com/avatars/richard_lopez.png');
...
'{"emotional_state": "Neutral", "behavioral_rules": ["Uses painkillers excessively"]}', 
'Severe abdominal pain',
'{"bp": "146/75", "hr": 81, "spo2": 97, "rr": 17, "temp": "37.2°C"}',
'{"role": "Medical Learner", "task": "Evaluate and diagnose", "procedure": ["Enter room", "Interaction", "Reasoning"]}',
...
30, 15, 'Intermediate', '{"rules": ["Chief Concern", "HPI", "Diagnostic Impression"], "totalTime": "45 mins"}', 'active', 'https://example.com/avatars/donna_davis.png');
...
'Chronic abdominal pain',
'{"bp": "137/70", "hr": 66, "spo2": 100, "rr": 22, "temp": "37.1°C"}',
'{"role": "Medical Learner", "task": "Evaluate and diagnose", "procedure": ["Enter room", "Interaction", "Reasoning"]}',
...
30, 15, 'Intermediate', '{"rules": ["Chief Concern", "HPI", "Diagnostic Impression"], "totalTime": "45 mins"}', 'active', 'https://example.com/avatars/william_martinez.png');
...
'Nausea and abdominal pain',
'{"bp": "113/85", "hr": 80, "spo2": 98, "rr": 20, "temp": "36.6°C"}',
'{"role": "Medical Learner", "task": "Evaluate and diagnose", "procedure": ["Enter room", "Interaction", "Reasoning"]}',
...
30, 15, 'Intermediate', '{"rules": ["Chief Concern", "HPI", "Diagnostic Impression"], "totalTime": "45 mins"}', 'active', 'https://example.com/avatars/michael_smith.png');
...
'Chronic abdominal pain',
'{"bp": "123/74", "hr": 93, "spo2": 98, "rr": 22, "temp": "37.0°C"}',
'{"role": "Medical Learner", "task": "Evaluate and diagnose", "procedure": ["Enter room", "Interaction", "Reasoning"]}',
...
30, 15, 'Intermediate', '{"rules": ["Chief Concern", "HPI", "Diagnostic Impression"], "totalTime": "45 mins"}', 'active', 'https://example.com/avatars/sandra_jackson.png');
...
'{"bp": "145/89", "hr": 74, "spo2": 100, "rr": 19, "temp": "36.6°C"}',
'{"role": "Medical Learner", "task": "Evaluate and diagnose", "procedure": ["Enter room", "Interaction", "Reasoning"]}',
...
30, 15, 'Intermediate', '{"rules": ["Chief Concern", "HPI", "Diagnostic Impression"], "totalTime": "45 mins"}', 'active', 'https://example.com/avatars/matthew_jones.png');
...
'Nausea and abdominal pain',
'{"bp": "144/84", "hr": 78, "spo2": 98, "rr": 21, "temp": "36.8°C"}',
'{"role": "Medical Learner", "task": "Evaluate and diagnose", "procedure": ["Enter room", "Interaction", "Reasoning"]}',
...
30, 15, 'Intermediate', '{"rules": ["Chief Concern", "HPI", "Diagnostic Impression"], "totalTime": "45 mins"}', 'active', 'https://example.com/avatars/jessica_gonzalez.png');
...
'{"emotional_state": "Neutral", "behavioral_rules": ["Low pain tolerance"]}', 
'Chronic abdominal pain',
'{"bp": "120/93", "hr": 62, "spo2": 100, "rr": 16, "temp": "36.7°C"}',
'{"role": "Medical Learner", "task": "Evaluate and diagnose", "procedure": ["Enter room", "Interaction", "Reasoning"]}',
...
30, 15, 'Intermediate', '{"rules": ["Chief Concern", "HPI", "Diagnostic Impression"], "totalTime": "45 mins"}', 'active', 'https://example.com/avatars/emily_rodriguez.png');
...
'Chronic abdominal pain', 
'{"bp": "114/84", "hr": 86, "spo2": 100, "rr": 20, "temp": "36.7°C"}',
'{"role": "Medical Learner", "task": "Evaluate and diagnose", "procedure": ["Enter room", "Interaction", "Reasoning"]}',
...
30, 15, 'Intermediate', '{"rules": ["Chief Concern", "HPI", "Diagnostic Impression"], "totalTime": "45 mins"}', 'active', 'https://example.com/avatars/william_miller.png');
...
'{"emotional_state": "Anxious", "behavioral_rules": ["High anxiety"]}', 
'Chronic abdominal pain',
'{"bp": "137/84", "hr": 89, "spo2": 97, "rr": 19, "temp": "37.2°C"}',
'{"role": "Medical Learner", "task": "Evaluate and diagnose", "procedure": ["Enter room", "Interaction", "Reasoning"]}',
...
30, 15, 'Intermediate', '{"rules": ["Chief Concern", "HPI", "Diagnostic Impression"], "totalTime": "45 mins"}', 'active', 'https://example.com/avatars/daniel_thomas.png');
...
'Intermittent abdominal pain',
'{"bp": "133/93", "hr": 80, "spo2": 97, "rr": 19, "temp": "36.9°C"}',
'{"role": "Medical Learner", "task": "Evaluate and diagnose", "procedure": ["Enter room", "Interaction", "Reasoning"]}',
...
30, 15, 'Intermediate', '{"rules": ["Chief Concern", "HPI", "Diagnostic Impression"], "totalTime": "45 mins"}', 'active', 'https://example.com/avatars/michael_hernandez.png');
...
'Chronic abdominal pain',
'{"bp": "112/94", "hr": 97, "spo2": 98, "rr": 18, "temp": "37.2°C"}',
'{"role": "Medical Learner", "task": "Evaluate and diagnose", "procedure": ["Enter room", "Interaction", "Reasoning"]}',
...
30, 15, 'Intermediate', '{"rules": ["Chief Concern", "HPI", "Diagnostic Impression"], "totalTime": "45 mins"}', 'active', 'https://example.com/avatars/thomas_lopez.png');
...
'{"emotional_state": "Anxious", "behavioral_rules": ["Health anxiety"]}', 
'Intermittent abdominal pain',
'{"bp": "106/65", "hr": 46, "spo2": 97, "rr": 18, "temp": "36.4°C"}',
'{"role": "Medical Learner", "task": "Evaluate and diagnose", "procedure": ["Enter room", "Interaction", "Reasoning"]}',
...
30, 15, 'Intermediate', '{"rules": ["Chief Concern", "HPI", "Diagnostic Impression"], "totalTime": "45 mins"}', 'active', 'https://example.com/avatars/susan_thomas.png');
...
'Intermittent abdominal pain',
'{"bp": "112/93", "hr": 76, "spo2": 100, "rr": 16, "temp": "37.1°C"}',
'{"role": "Medical Learner", "task": "Evaluate and diagnose", "procedure": ["Enter room", "Interaction", "Reasoning"]}',
...
30, 15, 'Intermediate', '{"rules": ["Chief Concern", "HPI", "Diagnostic Impression"], "totalTime": "45 mins"}', 'active', 'https://example.com/avatars/william_brown.png');
...
'Chronic abdominal pain',
'{"bp": "123/94", "hr": 65, "spo2": 98, "rr": 18, "temp": "36.9°C"}',
'{"role": "Medical Learner", "task": "Evaluate and diagnose", "procedure": ["Enter room", "Interaction", "Reasoning"]}',
...
30, 15, 'Intermediate', '{"rules": ["Chief Concern", "HPI", "Diagnostic Impression"], "totalTime": "45 mins"}', 'active', 'https://example.com/avatars/michael_miller.png');
...
'Severe abdominal pain',
'{"bp": "114/90", "hr": 68, "spo2": 98, "rr": 16, "temp": "36.9°C"}',
'{"role": "Medical Learner", "task": "Evaluate and diagnose", "procedure": ["Enter room", "Interaction", "Reasoning"]}',
...
30, 15, 'Intermediate', '{"rules": ["Chief Concern", "HPI", "Diagnostic Impression"], "totalTime": "45 mins"}', 'active', 'https://example.com/avatars/mary_taylor.png');



INSERT INTO labtestitem (itemid, label, fluid, category, count) VALUES 
(51222, 'Hemoglobin', 'Blood', 'Hematology', 1000),
...
INSERT INTO laboratorytest (clinicalcase_id, itemid, value, rangelower, rangeupper) VALUES
('20890008', 51222, '13.1 g/dL', '12.0', '16.0'),
...
INSERT INTO radiologyreport (clinicalcase_id, noteid, modality, region, examname, text) VALUES 
('20890008', '10040626-RR', 'CT', 'Abdomen', 'CT ABD & PELVIS WITH CONTRAST', 'Appendix measures up to 9 mm, likely representing appendicitis with mucosal hyperenhancement.'),
('27892518', '10070247-RR', 'CT', 'Abdomen', 'CT ABD & PELVIS WITH CONTRAST', 'Enlarged and fluid-filled appendix measuring up to 2.1 cm with surrounding fat stranding.'),
('21807759', '10073256-RR', 'CT', 'Abdomen', 'CT ABDOMEN W/CONTRAST', 'Hyperemic dilated appendix (16 mm) with a proximal appendicolith and cecal wall thickening.'),
('20345216', '10080679-RR', 'Ultrasound', 'Abdomen', 'US ABD LIMIT', 'Noncompressible tubular structure (1.3 cm) likely the appendix with heterogeneous debris.'),
('24078130', '10085111-RR', 'CT', 'Abdomen', 'CT ABD & PELVIS WITH CONTRAST', 'Appendix dilated to 9 mm, fluid filled, periappendiceal stranding.'),
('23919775', '10139369-RR', 'CT', 'Abdomen', 'CT ABD & PELVIS WITH CONTRAST', '11 mm dilated fluid-filled appendix with hyperemic walls, findings compatible with appendicitis.'),
('27022201', '10154376-RR', 'CT', 'Abdomen', 'CT ABD & PELVIS WITH CONTRAST', 'Dilated appendix measures 12 mm with hyperdense focus at distal aspect (appendicolith).'),
('24238743', '10156068-RR', 'CT', 'Abdomen', 'CT ABD & PELVIS WITH CONTRAST', 'Appendix dilated to 8 mm, fluid filled with hyperenhancing wall, consistent with appendicitis.'),
('26687335', '10185476-RR', 'CT', 'Abdomen', 'CT ABD & PELVIS W/O CONTRAST', 'Appendix mildly dilated to 9 mm with surrounding fat stranding and cecal thickening.'),
('21409557', '10205542-RR', 'CT', 'Abdomen', 'CT ABD & PELVIS WITH CONTRAST', 'Appendix dilated up to 9 mm with enhancing wall and adjacent fat stranding.'),
('25514003', '10071659-RR', 'CT', 'Abdomen', 'CT ABDOMEN W/CONTRAST', 'Gallbladder appears normal. Round lesion (18x19 mm) likely a prominent pancreatic lobule.'),
('27553284', '10069551-RR', 'Ultrasound', 'Abdomen', 'US LIVER/GALLBLADDER', 'Gallbladder contracted with several small shadowing stones. No wall edema.'),
('29328838', '10058856-RR', 'CT', 'Abdomen', 'CT ABD & PELVIS W/O CONTRAST', 'Sigmoid wall thickening sequelae from chronic diverticular disease. 19 mm renal cyst.'),
('20535755', '10056223-RR', 'Ultrasound', 'Abdomen', 'US LIVER/GALLBLADDER', 'Hyperechoic area in segment VI (previous RFA site). CBD measures 5 mm, enlarged spleen (14 cm).'),
('27361644', '10052530-RR', 'CT', 'Abdomen', 'CT ABD & PELVIS WITH CONTRAST', 'Retrocecal appendix is fluid-filled with hyperemic and thickened wall concerning for early appendicitis.'),
('24019757', '10046241-RR', 'CT', 'Abdomen', 'CT ABD W&W/O C', 'Large non-enhancing area in pancreatic head compatible with necrotizing pancreatitis.'),
('28694648', '10042037-RR', 'CT', 'Abdomen', 'CT ABD & PELVIS WITH CONTRAST', 'Extensive fat stranding from sigmoid mesocolon with extraluminal gas, secondary to perforated diverticulitis.'),
('27850323', '10040056-RR', 'MRCP', 'Abdomen', 'MR ABD W&W/OC', 'Expansion of pancreatic tail compatible with pancreatitis with necrosis and hemorrhage.'),
('21166109', '10034272-RR', 'CT', 'Abdomen', 'CT ABDOMEN W/CONTRAST', 'Gallbladder wall thick (6 mm) with surrounding fat stranding concerning for cholecystitis.'),
('29897948', '10031940-RR', 'CT', 'Abdomen', 'CT ABD & PELVIS WITH CONTRAST', 'Large non-calcified gallstone (2.5x2 cm) in a distended gallbladder. Hepatic steatosis.');


INSERT INTO expert_laboratory (expert_id, labtest_id) 
SELECT 'USR-EXP-001', id FROM laboratorytest WHERE id <= 10;
INSERT INTO expert_laboratory (expert_id, labtest_id) 
SELECT 'USR-EXP-002', id FROM laboratorytest WHERE id > 10;

INSERT INTO expert_radiology (expert_id, radiology_report_id)
SELECT 'USR-EXP-001', id FROM radiologyreport WHERE id <= 10;
INSERT INTO expert_radiology (expert_id, radiology_report_id)
SELECT 'USR-EXP-002', id FROM radiologyreport WHERE id > 10;



INSERT INTO expert_clinical_case_management (expert_id, case_id) VALUES
('USR-EXP-001', '27892518'), ('USR-EXP-001', '21807759'), ('USR-EXP-001', '20345216'), 
('USR-EXP-001', '24078130'), ('USR-EXP-001', '23919775'), ('USR-EXP-001', '27022201'), 
('USR-EXP-001', '24238743'), ('USR-EXP-001', '26687335'), ('USR-EXP-001', '21409557'), 
('USR-EXP-001', '25514003'), ('USR-EXP-002', '27553284'), ('USR-EXP-002', '29328838'), 
('USR-EXP-002', '20535755'), ('USR-EXP-002', '27361644'), ('USR-EXP-002', '24019757'), 
('USR-EXP-002', '28694648'), ('USR-EXP-002', '20890008'), ('USR-EXP-002', '27850323'), 
('USR-EXP-002', '21166109'), ('USR-EXP-002', '29897948');

INSERT INTO expert_virtual_patient_management (expert_id, virtual_id) VALUES
('USR-EXP-001', '10070247'), ('USR-EXP-001', '10073256'), ('USR-EXP-001', '10080679'), 
('USR-EXP-001', '10085111'), ('USR-EXP-001', '10139369'), ('USR-EXP-001', '10154376'), 
('USR-EXP-001', '10156068'), ('USR-EXP-001', '10185476'), ('USR-EXP-001', '10205542'), 
('USR-EXP-001', '10071659'), ('USR-EXP-002', '10069551'), ('USR-EXP-002', '10058856'), 
('USR-EXP-002', '10056223'), ('USR-EXP-002', '10052530'), ('USR-EXP-002', '10046241'), 
('USR-EXP-002', '10042037'), ('USR-EXP-002', '10040626'), ('USR-EXP-002', '10040056'), 
('USR-EXP-002', '10034272'), ('USR-EXP-002', '10031940');